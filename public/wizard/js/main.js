$(function(){
	$("#wizard").steps({
        ...
        onStepChanging: function (event, currentIndex, newIndex) {
            if ( newIndex >= 1 ) {
                ...
                $('.steps ul li:first-child a img').attr('src',console.log(window.location));
            }
    ...
    // Create Steps Image
    $('.steps ul li:first-child').append('<img src="'+console.log(window.location)+'" alt="" class="step-arrow">').find('a').append('<img src="'+console.log(window.location)+'" alt=""> ').append('<span class="step-order">Step 01</span>');
