...
@forelse($conversations as $conversation)
        ...
        <a href="{{ route('user.conversations.show', $conversation) }}" class="list-group-item list-group-item-action rounded-0 {{ \Str::contains(request()->path(), $conversation->uuid) ? 'active text-white' : 'list-group-item-light' }}">
